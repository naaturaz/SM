...
public class Animal : General
{
    ...
    /// </summary>
    /// <param name="howFar">How far will go</param>
    private Vector3 AssignAnimalRandomIniPosition(Vector3 origin, Rect area, float howFar, float animalDim)
    {
        float x = UMath.Random(-howFar, howFar);
        float z = UMath.Random(-howFar, howFar);
    ...
    private void AddToBuildingInvIfHasRawResourceToProduceIt(P prod, float amt)
    {
