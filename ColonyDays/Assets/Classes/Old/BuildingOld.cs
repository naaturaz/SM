...
public class BuildingOld : MonoBehaviour
{
    ...
    private void FindRemaindingOnes()
    {
    }
	...
	*/
    ...
    //
    private void UpdateXLenght(Vector3 originPass, int index)
    {
        //step 1 : xGoToLeft
    ...
    private void FindAllVertexBelowBulding()
    {
    ...
    private void FindVerticeIndex(Vector3 vertex, string name)
    {
    ...
    private void AddToList(Vector3 vertex, int index)
    {
    ...
    private void CreateHelper(string helperType, Vector3 vertex, int index)
    {
