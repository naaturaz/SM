...
public class RouterManager
{
    ...
    private DeltaCapsule _deltaCapsule;
    ...
    private BridgeRouter _bridgeRouter; //BridgeRouter _bridgeRouter = new BridgeRouter();
    ...
    private void PullRouteOfDeltaCapsule()
    {
    ...
    /// <returns></returns>
    private static bool IsLayerInBtw(Vector3 origin, Vector3 target, int layer)
    {
    ...
    #endregion Bridge Routing
}

internal class BridgeHelp
{
    private float _dist;
