...
public class BridgeRouter : MonoBehaviour
{
    ...
    private List<Bridge> _virginBridges = new List<Bridge>();
     ...
     */
    private List<Bridge> _usedBridges = new List<Bridge>();

    private List<Bridge> _reachBridges = new List<Bridge>();//brdiges I can reach from '_currentIni' point
    private List<Bridge> _unReachBridges = new List<Bridge>();//brdiges I can not reach from '_currentIni' point

    //brdiges I can reach from '_currentIni' point but cant walk directly from them to "_currentFin'
    private List<Bridge> _reachBridgesFail = new List<Bridge>();
    ...
    private List<Bridge> _triedBridges = new List<Bridge>();
    ...
    private TheRoute _theRoute = new TheRoute();//the final route of this classs
    ...
    /// </summary>
    private void AvoidInfiniteRecursion()
    {
        nullBridgeCount++;
    ...
    private CanIReach _canIReach = new CanIReach();
    ...
    /// </summary>
    private void CheckFindReachBrigeStatus()
    {
    ...
    #endregion Reachable Brdiges

    #region Crossing Brdige

    private int canIWalk = -5;
    private CanIReach _canIReachCross = new CanIReach();
    ...
    private void DecideIfCrossingLastBridgeWasEnough()
    {
        if (canIWalk == 1)
        {
    ...
    /// </summary>
    private void AddFirtAndLastToBucket()
    {
    ...
    /// <returns></returns>
    private CheckPoint ReturnFacingTo(Vector3 from, Vector3 facingTo, Vector3 iniPos)
    {
    ...
    /// </summary>
    private void DefineBridges(Vector3 iniPos)
    {
    ...
    /// </summary>
    private void LeaveOnlyTheOnesFullyBuiltAndUnMarked()
    {
    ...
    private List<Bridge> FindBridges()
    {
    ...
    private CanIReach _canIReachBridge = new CanIReach();
    private int index;
    ...
    private Bridge GetClosestBridgeICanWalkTo(List<Bridge> br, Vector3 from)
    {
        if (index < br.Count)
        {
